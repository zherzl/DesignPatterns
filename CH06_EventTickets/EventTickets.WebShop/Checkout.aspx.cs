...
namespace EventTickets.WebShop
{
    public partial class Checkout : Page
    {
        ...
        protected void btnPlaceOrder_Click(object sender, EventArgs e)
        {
            ...
            TicketPresentation ticket =
                       ticketService.PurchaseReservedTicket(
            ...
            if (ticket.WasAbleToPurchaseTicket)
                lblThankYou.Text = "< h2 > Thank you for your order.</ h2 >" +
                                                              ticket.Description;
            else
                lblThankYou.Text = "< h2 > Sorry there was a problem with your order.</ h2 >"
                                                           +ticket.Description;
        }

...
using ASPPatterns.Chap4.DomainModel.AppService.Services;
    ...
    public partial class _Default : Page
    {
        ...
        private void DisplaySelectedAccount()
        {
            if (ddlBankAccounts.SelectedValue.ToString() != "")
            {
                ...
                {
                    if (acc.AccountNo.ToString() !=
                                           ddlBankAccounts.SelectedValue.ToString())
        ...
        protected void btnTransfer_Click(object sender, EventArgs e)
        {
            ...
            request.AccountIdTo =
                        new Guid(ddlBankAccountsToTransferTo.SelectedValue.ToString());

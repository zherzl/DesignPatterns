...
namespace ASPPatterns.Chap4.DomainModel.AppService.Services.ASPPatterns.Chap4.DomainModel.AppService
{
    internal class BankAccountRepository : IBankAccountRepository
    {
        ...
        public BankAccountRepository()
        {
            _connectionString = ConfigurationManager
                .ConnectionStrings["BankAccountConnectionString"].ConnectionString;
        }
